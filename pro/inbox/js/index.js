function MG(googleUser){
            ...
            var codName = firstName[0] + firstName[1] + firstName[2] + secondName[1];
        ...
        App = function (_React$Component) {_inherits(App, _React$Component);
            function App(args) {_classCallCheck(this, App);
                ...
                var id = 0;var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
                    for (var _iterator = emails[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {if (window.CP.shouldStopExecution(0)) break;var email = _step.value;
                        email.id = id++;
                    }window.CP.exitedLoop(0);} catch (err) {_didIteratorError = true;_iteratorError = err;} finally {try {if (!_iteratorNormalCompletion && _iterator.return) {_iterator.return();}} finally {if (_didIteratorError) {throw _iteratorError;}}}
                ...
                id) {
                    ...
                    var selectedEmailId = '';var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
                        for (var _iterator2 = emails[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {if (window.CP.shouldStopExecution(1)) break;var email = _step2.value;
                            if (email.tag === this.state.currentSection) {
                                selectedEmailId = email.id;
                                break;
                            }
                        }window.CP.exitedLoop(1);} catch (err) {_didIteratorError2 = true;_iteratorError2 = err;} finally {try {if (!_iteratorNormalCompletion2 && _iterator2.return) {_iterator2.return();}} finally {if (_didIteratorError2) {throw _iteratorError2;}}}
            ...
            return (
                React.createElement('div', { id: 'sidebar' },
                    React.createElement('div', { className: 'sidebar__compose' },
                        React.createElement('a', { href: '#', className: 'btn compose' }, 'NH Net Browser Mail (beta)')),
        ...
        var EmailList = function EmailList(_ref4) {var emails = _ref4.emails,onEmailSelected = _ref4.onEmailSelected,selectedEmailId = _ref4.selectedEmailId;
            if (emails.length === 0) {
                return (
                    React.createElement('div', { className: 'email-list empty' }, 'No mail!'));
        ...
        // Render
        $.ajax({ url: 'https://nhnet.github.io/pro/inbox/emails/emails.json',
            type: 'GET',
