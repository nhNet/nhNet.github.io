...
function OpenTwitch(streamer, attr){
    ...
    document.body.innerHTML='<div><input style="width:20%;" class="Box" placeholder="Streamer: eg. Ninja" value="'+streamer+'" type="text"><input placeholder="Attributes: eg. style=&quot;&quot;" value="'+attr+'" style="width:30%;" class="Box2" type="text"><button accesskey="h" onclick="SUBMITtwitch();">Submit Chromebook Fullscreen</button><br><br><div style="text-align:right;"><iframe frameborder="0" style="margin:-7.6px;" width="76.2%" allowfullscreen="true" height="725.5px" src="https://player.twitch.tv/?channel=' + streamer + '"' + attr + '>Your Browser does not support Iframes. Get a new one!</iframe><iframe src="https://www.twitch.tv/embed/dakotaz/chat" width="25%" height="725.5px" frameborder="0"></iframe></div>';
}
