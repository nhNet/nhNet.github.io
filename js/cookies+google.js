...
function onSignIn(googleUser) {
	...
	switch (profileEmail){						//check if account exists
		...
		case "nicolas.arr.gra@kcpupils.org":
		case "juanpablo.bis@kcpupils.org":
		case "alonso.cas@kcpupils.org":
		case "david.eze.zam@kcpupils.org":
		case "diego.mor.man@kcpupils.org":
		case "andrew.row@kcpupils.org":
		case "beatriz.tay.rod@kcpupils.org":
		case "constanza.par.hor@kcpupils.org":
		case "daniel.mar.her@kcpupils.org":
		case "pablo.sai.mon@kcpupils.org":
		case "borja.alf.vic@kcpupils.org":
		...
		case "rodrigo.alv.bor@kcpupils.org":	//Add Rodrigo A
			if(profileEmail=="daniel.mar.her@kcpupils.org"||profileEmail=="constanza.par.hor@kcpupils.org"||profileEmail=="beatriz.tay.rod@kcpupils.org"||profileEmail=="nicolas.arr.gra@kcpupils.org" || profileEmail=="pablo.sai.mon@kcpupils.org" || profileEmail=="spbong999@gmail.com"|| profileEmail=="andrew.row@kcpupils.org" || profileEmail=="borja.alf.vic@kcpupils.org" || profileEmail=="diego.mor.man@kcpupils.org" || profileEmail=="alonso.cas@kcpupils.org"||profileEmail=="david.eze.zam@kcpupils.org"|| profileEmail=="juanpablo.bis@kcpupils.org" || profileEmail=="gonzalo.agu.lag@kcpupils.org" || profileEmail=="ahmed.fte@kcpupils.org" || profileEmail=="pedrotomas.cob.agu@kcpupils.org" || profileEmail=="victor.arr.mar@kcpupils.org" || profileEmail=="rodrigo.par.rob@kcpupils.org" || profileEmail=="nicholas.hua@kcpupils.org" ||profileEmail=="patrickthomas.sch@kcpupils.org"||profileEmail=="antonio.sie.per@kcpupils.org" || profileEmail=="lucasgabriel.sal.bev@kcpupils.org" || profileEmail=="jorgegabriel.jof.vic@kcpupils.org"|| profileEmail=="nathan.wal.san@kcpupils.org"){	//check if account is pro
