	...
	switch (profileEmail){						//check if account exists
		...
		case "rodrigo.alv.bor@kcpupils.org":	//Add Rodrigo A
			if(profileEmail=="spbong999@gmail.com" || profileEmail=="nicholas.hua@kcpupils.org" ||profileEmail=="patrickthomas.sch@kcpupils.org"||profileEmail=="antonio.sie.per@kcpupils.org" || profileEmail=="lucasgabriel.sal.bev@kcpupils.org" || profileEmail=="jorgegabriel.jof.vic@kcpupils.org"|| profileEmail=="nathan.wal.san@kcpupils.org"){	//check if account is pro
				...
				setTimeout(function(){document.body.innerHTML="<h1>Go Pro to see what is happening now in the background.</h1><h1 style='font-size:150px;'>6</h1>";},1000);
				setTimeout(function(){document.body.innerHTML="<h1>Go Pro to see what is happening now in the background.</h1><h1 style='font-size:150px;'>5</h1>";},2000);
				setTimeout(function(){document.body.innerHTML="<h1>Go Pro to see what is happening now in the background.</h1><h1 style='font-size:150px;'>4</h1>";},3000);
				setTimeout(function(){document.body.innerHTML="<h1>Go Pro to see what is happening now in the background.</h1><h1 style='font-size:150px;'>3</h1>";},4000);
				setTimeout(function(){document.body.innerHTML="<h1>Go Pro to see what is happening now in the background.</h1><h1 style='font-size:150px;'>2</h1>";},5000);
				setTimeout(function(){document.body.innerHTML="<h1>Go Pro to see what is happening now in the background.</h1><h1 style='font-size:150px;'>1</h1>";},6000);
				setTimeout(function(){document.body.innerHTML="<h1>Go Pro to see what is happening now in the background.</h1><h1 style='font-size:150px;'>0</h1>";},7000);
