...
addEventListener(
    ...
    function FinishAdWithTwitch(){
        document.body.style.background="black";
        document.body.style.color="black";
        document.body.innerHTML='<span style="user-select:none;"><div style="background:url(https://cdn.pixabay.com/photo/2016/11/23/11/31/texture-1852621_960_720.jpg);margin-left:-7.51565px;margin-top:-7.51565px;background-size:220px 220px;border:5px solid black;width:100.38%;"><h1 style="font-size:50px;"><img style="border-radius:10px;background:white;margin:5px;" width="50px" height="50px" src="https://upload.wikimedia.org/wikipedia/commons/3/3a/Twitch_mit_Glitch.png"> NH Twitch Browser</h1></div><div style="margin-left:-7.51565px;height:400px;margin-top:-3px;width:30%;font-size:50px;border:3px solid black;color:#FFFFFF;font-weight:bolder;padding:20px;background:url(https://www.publicdomainpictures.net/pictures/130000/velka/seamless-pattern-1441887175yUH.jpg);background-size:100px 100px;"><div style="text-align:left;">Twitch Streamer<span style="color:red;"><b><u>*</u></b></span>:<br><input style="width:90%;border-radius:25px;font-size:40px;" class="Box" placeholder="eg. Ninja" type="text"></div><br><div style="text-align:left;">Add any attributes (Optional):<br><input placeholder="eg. allowfullscreen=&quot;true&quot;" style="height:50px;width:90%;border-radius:300px;font-size:20px;" class="Box2" type="text"></div></div><div style="margin-top:-444px;margin-left:443px;width:44.04%;background:url(https://www.publicdomainpictures.net/pictures/120000/velka/abstract-colorful-seamless-pattern.jpg);background-size:300px 270px;border:3px solid black;padding:157px;"><button style="font-size:50px;background:lightblue;border-radius:300px;" accesskey="h" onclick="SUBMITtwitch();">Submit Chromebook Fullscreen</button></div></span><div style="text-align:center;background:#efdd97;height:166px;margin-left:-7.51565px;width:100.38%;border:5px solid black;"><h1>If you do not understand this website, (including: its purposes, how to use it and how it is done) please '+ "don't"+' hesitate to ask the developer of this website any questions at <a href="mailto:spbong999@gmail.com">this email address.</a></h1><h1>If any further questions need answering just check out the <a href="https://nhnet.github.io/info/"> info page.</a></h1></div>';
    }
    ...
    function FinishAdWithYoutube(){
        document.body.style.background="black";
        document.body.style.color="black";
        document.body.innerHTML='<span style="user-select:none;"><div style="background:url(https://cdn.pixabay.com/photo/2016/11/23/11/31/texture-1852621_960_720.jpg);margin-left:-7.51565px;margin-top:-7.51565px;background-size:220px 220px;border:5px solid black;width:100.38%;"><h1 style="font-size:50px;"><img style="border-radius:10px;background:white;margin:5px;" width="50px" height="50px" src="http://www.underconsideration.com/brandnew/archives/youtube_logo_detail.png"> NH YouTube Browser</h1></div><div style="margin-left:-7.51565px;height:400px;margin-top:-3px;width:30%;font-size:50px;border:3px solid black;color:#FFFFFF;font-weight:bolder;padding:20px;background:url(https://www.publicdomainpictures.net/pictures/130000/velka/seamless-pattern-1441887175yUH.jpg);background-size:100px 100px;"><br><br><div style="text-align:left;">YouTube video ID:<br><input style="width:90%;border-radius:25px;font-size:40px;" class="Box" placeholder="e.g. 7Qp5vcuMIlk" type="text"></div></div><div style="margin-top:-444px;margin-left:443px;width:44.04%;background:url(https://www.publicdomainpictures.net/pictures/120000/velka/abstract-colorful-seamless-pattern.jpg);background-size:300px 270px;border:3px solid black;padding:157px;"><button style="font-size:50px;background:lightblue;border-radius:300px;" accesskey="h" onclick="SUBMITyoutube();">Submit Chromebook Fullscreen</button></div></span><div style="text-align:center;background:#efdd97;height:166px;margin-left:-7.51565px;width:100.38%;border:5px solid black;"><h1>If you do not understand this website, (including: its purposes, how to use it and how it is done) please '+ "don't"+' hesitate to ask the developer of this website any questions at <a href="mailto:spbong999@gmail.com">this email address.</a></h1><h1>If any further questions need answering just check out the <a href="https://nhnet.github.io/info/"> info page.</a></h1></div>';
    }
Ad();
