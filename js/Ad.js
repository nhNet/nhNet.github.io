...
//Made by Nicholas Huaman
    ...
    function FinishAd(){
        ...
        document.body.innerHTML='<span style="user-select:none;"><h1 style="font-size:50px;color:white;font-family: "Black Han Sans", sans-serif;">NH Net Browser</h1></span><a href="https://google.com"><div style="margin-left:-7.4px;background:white;border:2px solid black;width:50%;height:325px;"><img height="90%" width="100%" src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png"><div style="color:black; font-size:30px"><div style="height:10%;width:100%;">NH Google Browser Search</div></div></div></a><a href="youtube"><div style="margin-left:50%;margin-top:-327px;background:white;border:2px solid black;width:50%;height:325px;"><img height="90%" width="100%" src="http://www.underconsideration.com/brandnew/archives/youtube_logo_detail.png"><div style="color:black; font-size:30px"><div style="height:10%;width:100%;">NH YouTube</div></div></div></a><a href="twitch"><div style="margin-left:-7.4px;background:white;border:2px solid black;width:50%;height:325px;"><img height="90%" width="100%" src="https://upload.wikimedia.org/wikipedia/commons/3/3a/Twitch_mit_Glitch.png"><div style="color:black; font-size:30px"><div style="height:10%;width:100%;">NH Twitch</div></div></div></a><a href="info"><div style="margin-left:50%;margin-top:-327px;background:white;border:2px solid black;width:50%;height:325px;"><img height="90%" width="100%" src="https://upload.wikimedia.org/wikipedia/en/5/54/Information.png"><div style="color:black; font-size:30px"><div style="height:10%;width:100%;">Info</div></div></div></a>';
    }
