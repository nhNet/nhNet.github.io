...
//Made by Nicholas Huaman
    ...
    function FinishAd(){
        ...
        document.body.innerHTML='<span style="user-select:none;"><h1 style="font-size:50px;color:white;font-family: "Black Han Sans", sans-serif;">NH Net Browser</h1></span><a href="twitch"><span style="margin-left:-7.4px;background:white;border:5px black;width:50%;height:650px;"><img height="90%" width="100%" src="https://upload.wikimedia.org/wikipedia/commons/3/3a/Twitch_mit_Glitch.png"><div style="color:black; font-size:30px"><div style="height:10%;width:100%;">NH Twitch</div></div></span></a><a href="info"><span style="background:white;border:5px black;width:50%;height:650px;"><img height="90%" width="100%" src="https://upload.wikimedia.org/wikipedia/en/5/54/Information.png"><div style="color:black; font-size:30px"><div style="height:10%;width:100%;">Info</div></span></a>'
    }
