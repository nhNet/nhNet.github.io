...
addEventListener(
    ...
    document.body.innerHTML='<div class="welcome"></div><div style="margin-top:2.5%;height:630px;font-family:'+ "'Gamja Flower'"+', cursive;background:#004000;margin-left:20%;width:60%;border-radius:50px;border:3px solid white;"><img style="margin-left:-450px;margin-top:25px;width:120px;height:120px;" src="https://huamangames.github.io/resources.a8h2_HuamanGames/files/Huaman/HuamanGames/all/ok/Game/Resources/Don-t/find/this/images/logo.png"><h1 style="margin-left:150px;margin-top:-100px;font-size:50px;"><u><b>NH Net Browser - v2.0</b></u></h1><div style="margin-top:100px;margin-left:-400px"><h1><u>Update Releases:</u></h1><div style="margin-left:-50px;"><h3>&middot;Google Signup</h3><h3>&middot;Pro Accounts</h3><h3>&middot;Web Statistics</h3><h3>&middot;Analytics</h3><h3>&middot;Plans for future Browser Apps</h3><h3>&middot;Credits</h3></div></div><div style="margin-top:-350px;margin-left:400px"><h1><u><b>Login</b></u></h1><h2 style="margin-top:-30px;"><span style="color:red;">Warning:</span> Do NOT do this until you are perfectly sure that you have a reserved account. If you press this button without knowing, you shall probably find yourself blocked out of this browser forever.</h2><div style="margin-left:100px;" class="g-signin2" data-onsuccess="onSignIn" data-onfailure="onFail"></div><button onclick="login();signOut();">Sign Out</button></div></div>';
    }
