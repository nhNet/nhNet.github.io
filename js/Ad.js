...
//Made by Nicholas Huaman
    ...
    function FinishAdWithYoutube(){
        document.body.style.background="white";
        document.body.style.color="black";
        document.body.innerHTML='<span style="user-select:none;"><h1 style="font-size:50px;"><img style="margin:5px;" width="50px" height="50px" src="http://www.underconsideration.com/brandnew/archives/youtube_logo_detail.png"> NH Youtube Browser</h1><br><br><p>This page allows you to view youtube videos without it saving in your history or on your network. All you shall see there is this website! :)</p><p>Please note: Extensions (Like Omnito and Netop) can see this... <br><br><p>Press the keys alt+H to search without pressing the button. (More discreet)</p><br><br><span style="user-select:none;"><div>Youtube video id: <input style="width:30%;" class="Box" placeholder="e.g. 7Qp5vcuMIlk" type="text"></div><button accesskey="h" onclick="SUBMITyoutube();">Submit Chromebook Fullscreen</button></span><br><br><p>NH YouTube Browser <b> is allowed by YouTube</b> to embed their videos.</p>'
    }
Ad();
