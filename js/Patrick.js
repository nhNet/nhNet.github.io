...
function PatrickTalk(){
    if(localStorage['rudeComments']<100){
        ...
        try{
            ...
            if(document.querySelector('#input').value!=''){
                ...
                // Common responses
                if(isInInput(uCMD,'hello')||isInInput(uCMD,'hi ')||isInInput(uCMD,'hi,')||isInInput(uCMD,'hello,')){s.innerHTML='Hi, '+localStorage['name']+'!<br>How do you do?<br><span style="font-size:50px;">&nbsp;&nbsp;&nbsp;🙂</span>';}
