...
//Made by Nicholas Huaman
    ...
    function FinishAd(){
        ...
        document.body.innerHTML='<div style="user-select:none;"><h1 style="font-size:50px;">Huaman Proxy!</h1><br><br><p>This page allows you to go on most sites without it saving in your history. All you shall see there is this website! :)</p><p>WARNING: All Google webpages do not work. Look it up, and paste the link of the website you want to visit here.</p><p>FIND THE CORRECT LINK! Any errors will cause your page not to load...</p><br><br><p>Press the keys alt+H to search without pressing the button. (More discreet)</p></div><p>To view youtube videos you visit "https://youtube.com/embed/" and add the video ID.</p><p>To view twitch streams you visit "https://player.twitch.tv/?channel=" and add the streamer name!</p><br><br><div style="user-select:none;"><input style="width:60%;" class="Box" type="text" value="https://"><button accesskey="h" onclick="SUBMIT();">Submit Chromebook Fullscreen</button></div>'
    }
